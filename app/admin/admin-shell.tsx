...
const copy = {
  en: { title: "iHear Admin", overview: "Overview", content: "Website content", team: "Team", impact: "Impact", media: "Media galleries", resources: "Resources", trash: "Trash", admins: "Administrators", publicSite: "View public site", signOut: "Sign out", owner: "Owner", editor: "Editor", menu: "Open menu" },
  zhHant: { title: "iHear 管理後台", overview: "總覽", content: "網站內容", team: "團隊名冊", impact: "成果資料", media: "媒體展示", resources: "資源管理", trash: "回收區", admins: "管理員", publicSite: "查看公開網站", signOut: "登出", owner: "擁有者", editor: "編輯者", menu: "開啟選單" },
  zhHans: { title: "iHear 管理后台", overview: "总览", content: "网站内容", team: "团队名册", impact: "成果数据", media: "媒体展示", resources: "资源管理", trash: "回收区", admins: "管理员", publicSite: "查看公开网站", signOut: "登出", owner: "拥有者", editor: "编辑者", menu: "打开菜单" },
};
...
function ShellContent({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    ["/admin/impact", text.impact, "▥"], ["/admin/media", text.media, "▧"], ["/admin/resources", text.resources, "☷"], ["/admin/trash", text.trash, "♲"],
