  ...
  return (
    ...
    >
      <section style={{ width: "min(680px, 100%)", textAlign: "center" }} aria-labelledby="not-found-title">
        ...
        <h1 id="not-found-title" style={{ margin: "14px 0 12px", color: colors.navy, fontSize: "clamp(2rem, 6vw, 3.2rem)", lineHeight: 1.15 }}>
          Page not found
        </h1>
        ...
        <p style={{ margin: "0 auto", color: colors.inkSoft, fontSize: "1rem", lineHeight: 1.7 }}>
          找不到此頁面，網址可能已變更。 · 找不到此页面，网址可能已更改。
        </p>
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 12, marginTop: 30 }}>
          <a href="/" style={{ minHeight: 48, display: "inline-flex", alignItems: "center", padding: "0 24px", borderRadius: 999, background: colors.orange, color: "#3A2410", fontWeight: 900, textDecoration: "none" }}>
            Home · 回到首頁
          </a>
          <a href="/contact" style={{ minHeight: 48, display: "inline-flex", alignItems: "center", padding: "0 24px", borderRadius: 999, border: `2px solid ${colors.navyDeep}`, color: colors.navyDeep, fontWeight: 900, textDecoration: "none" }}>
            Contact · 聯絡我們
          </a>
        </div>
      </section>
