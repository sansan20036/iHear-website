(function () {
  ...
  "zhTW": {
    ...
    "zoe_r2": "導師培訓與課程共同總監",
    "role_leadtutor": "首席導師",
    "zoe_bio": "Zoe 創辦 iHear，以解決聽力損失及其他溝通需求學生面臨的溝通障礙。作為創辦人暨共同會長，她確立組織願景、引領長期策略，並代表 iHear 參與合作與社區倡議。她協助設計以建立自信、無障礙與真實溝通為優先的教學框架與培訓架構，並持續以首席導師身分積極參與。",
    "howard_r1": "共同會長",
    "howard_bio": "作為共同會長，Howard 支持 iHear 的策略規劃與組織協調，確保各項計畫順利運作並符合組織使命。他與其他領導者密切合作，支持執行、溝通與內部協作，並以首席導師身分為領導決策帶來第一線教學經驗與以學生為中心的視角。",
    "daniel_r1": "導師培訓與課程共同總監",
    "daniel_r2": "組長",
    "daniel_bio": "Daniel 在塑造 iHear 的教學品質與導師發展方面扮演核心角色。作為導師培訓與課程共同總監，他主導導師培訓、課程教材與品質標準的設計與實施。他同時擔任組長，支持導師團隊的協調與輔導，並透過結構化、重視關係的教學示範最佳實踐。",
    "tlnote_h": "組長——計畫營運與協調",
  ...
  "zhCN": {
    ...
    "zoe_r2": "导师培训与课程联合总监",
    "role_leadtutor": "首席导师",
    "zoe_bio": "Zoe 创办 iHear，以解决听力损失及其他沟通需求学生面临的沟通障碍。作为创始人兼联合会长，她确立组织愿景、引领长期战略，并代表 iHear 参与合作与社区倡议。她协助设计以建立自信、无障碍与真实沟通为优先的教学框架与培训体系，并持续以首席导师身份积极参与。",
    "howard_r1": "联合会长",
    "howard_bio": "作为联合会长，Howard 支持 iHear 的战略规划与组织协调，确保各项目顺利运作并符合组织使命。他与其他领导者密切合作，支持执行、沟通与内部协作，并以首席导师身份为领导决策带来一线教学经验与以学生为中心的视角。",
    "daniel_r1": "导师培训与课程联合总监",
    "daniel_r2": "组长",
    "daniel_bio": "Daniel 在塑造 iHear 的教学质量与导师发展方面扮演核心角色。作为导师培训与课程联合总监，他主导导师培训、课程教材与质量标准的设计与实施。他同时担任组长，支持导师团队的协调与辅导，并通过结构化、重视关系的教学示范最佳实践。",
    "tlnote_h": "组长——项目运营与协调",
